# Advanced Patterns & What's Next — Presentation
...
> **Transition**: One more practical session. We'll try agent teams, `/batch`, headless mode, and wrap up with a look back at everything you've accomplished. Let's finish strong.
