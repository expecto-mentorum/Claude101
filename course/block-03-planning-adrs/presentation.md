---
layout: default
title: "Block 3 — Presentation Notes"
---

# Block 3: Planning with ADRs & Diagrams — Presentation Notes
...
## Part 1: Plan Mode — Think Before You Act (3 min)
...
## Part 2: Architecture Decision Records (3 min)
...
## Part 3: Mermaid Diagrams — Diagrams as Code (2 min)
...
2. **Traffic flow** — User > DNS > Ingress > Service > Pod (how a request reaches the app)
...
## Part 4: The Dark Theme Plan (1 min)
